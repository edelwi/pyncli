...
class TestUacMetods(unittest.TestCase):
    ...
    def test___hex_TRUSTED_TO_AUTH_FOR_DELEGATION(self):
        self.assertEqual(
            int(uac.TRUSTED_TO_AUTH_FOR_DELEGATION.hex, 16), 0x1000000
        )
    ...
    def test___add_1(self):
        self.assertEqual(
            uac.TRUSTED_FOR_DELEGATION + uac.NORMAL_ACCOUNT, 0x80000 + 0x0200
        )

    def test___add_2(self):
        self.assertEqual(
            uac.ENCRYPTED_TEXT_PWD_ALLOWED + uac.NORMAL_ACCOUNT,
            0x0080 + 0x0200,
        )

    def test___add_3(self):
        self.assertEqual(
            uac.HOMEDIR_REQUIRED + uac.ACCOUNTDISABLE, 0x0008 + 0x0002
        )

    def test___add_4(self):
        self.assertEqual(
            uac.WORKSTATION_TRUST_ACCOUNT + uac.PASSWD_NOTREQD, 0x1000 + 0x0020
        )

    def test___add_5(self):
        self.assertEqual(
            uac.INTERDOMAIN_TRUST_ACCOUNT + uac.SCRIPT, 0x0800 + 0x0001
        )
    ...
    def test___add_7(self):
        self.assertEqual(
            uac.MNS_LOGON_ACCOUNT + uac.NORMAL_ACCOUNT, 0x20000 + 0x0200
        )

    def test___add_8(self):
        self.assertEqual(
            uac.TRUSTED_TO_AUTH_FOR_DELEGATION + uac.WORKSTATION_TRUST_ACCOUNT,
            0x1000000 + 0x1000,
        )

    def test___add_9(self):
        self.assertEqual(
            uac.PASSWD_CANT_CHANGE + uac.NOT_DELEGATED, 0x0040 + 0x100000
        )

    def test___add_10(self):
        self.assertEqual(
            uac.SMARTCARD_REQUIRED + uac.HOMEDIR_REQUIRED, 0x40000 + 0x0008
        )

    def test___add_not_10(self):
        self.assertNotEqual(
            uac.SMARTCARD_REQUIRED + uac.HOMEDIR_REQUIRED, 0x40000 + 0x0004
        )

    def test___add_11(self):
        self.assertEqual(
            uac.SERVER_TRUST_ACCOUNT + uac.DONT_REQ_PREAUTH, 0x2000 + 0x400000
        )

    def test___add_12(self):
        self.assertEqual(
            uac.PASSWORD_EXPIRED + uac.HOMEDIR_REQUIRED, 0x800000 + 0x0008
        )

    def test___add_13(self):
        self.assertEqual(
            uac.PASSWD_NOTREQD + uac.NORMAL_ACCOUNT, 0x0020 + 0x0200
        )

    def test___add_14(self):
        self.assertEqual(
            uac.DONT_EXPIRE_PASSWORD + uac.HOMEDIR_REQUIRED, 0x10000 + 0x0008
        )
    ...
    def test___add_16(self):
        self.assertEqual(
            uac.ACCOUNTDISABLE + uac.TRUSTED_FOR_DELEGATION, 0x0002 + 0x80000
        )

    def test___add_17(self):
        self.assertEqual(
            uac.NORMAL_ACCOUNT + uac.TRUSTED_TO_AUTH_FOR_DELEGATION,
            0x0200 + 0x1000000,
        )

    def test___add_18(self):
        self.assertEqual(
            uac.NOT_DELEGATED + uac.ENCRYPTED_TEXT_PWD_ALLOWED,
            0x100000 + 0x0080,
        )

    def test___add_19(self):
        self.assertEqual(
            uac.DONT_REQ_PREAUTH + uac.DONT_EXPIRE_PASSWORD, 0x400000 + 0x10000
        )
    ...
    def test___add_not_20(self):
        self.assertNotEqual(
            uac.USE_DES_KEY_ONLY + uac.SCRIPT, 0x200000 + 0x00011
        )

    def test___add_21(self):
        self.assertEqual(
            uac.TEMP_DUPLICATE_ACCOUNT + uac.TRUSTED_TO_AUTH_FOR_DELEGATION,
            0x0100 + 0x1000000,
        )

    def test___add_22(self):
        self.assertEqual(
            uac.SMARTCARD_REQUIRED + uac.SMARTCARD_REQUIRED, 0x40000
        )
    ...
    def test___add2_1(self):
        self.assertNotEqual(
            ...
            + uac.INTERDOMAIN_TRUST_ACCOUNT
            + uac.INTERDOMAIN_TRUST_ACCOUNT,
            0x80000 + 0x0800 + 0x0800,
        )
    ...
    def test___add2_2(self):
        self.assertEqual(
            ...
            + uac.PASSWORD_EXPIRED,
            0x0080 + 0x400000 + 0x800000,
        )

    def test___add2_3(self):
        self.assertEqual(
            uac.HOMEDIR_REQUIRED + uac.SMARTCARD_REQUIRED + uac.NOT_DELEGATED,
            0x0008 + 0x40000 + 0x100000,
        )

    def test___add2_4(self):
        self.assertEqual(
            uac.WORKSTATION_TRUST_ACCOUNT
            + uac.TEMP_DUPLICATE_ACCOUNT
            + uac.USE_DES_KEY_ONLY,
            0x1000 + 0x0100 + 0x200000,
        )
    ...
    def test___add2_5(self):
        self.assertEqual(
            ...
            + uac.WORKSTATION_TRUST_ACCOUNT
            + uac.NOT_DELEGATED,
            0x0800 + 0x1000 + 0x100000,
        )

    def test___add2_6(self):
        self.assertEqual(
            uac.SCRIPT + uac.NOT_DELEGATED + uac.INTERDOMAIN_TRUST_ACCOUNT,
            0x0001 + 0x100000 + 0x0800,
        )

    def test___add2_not_6(self):
        self.assertNotEqual(
            uac.SCRIPT + uac.NOT_DELEGATED + uac.INTERDOMAIN_TRUST_ACCOUNT,
            0x0002 + 0x100000 + 0x0800,
        )

    def test___add2_7(self):
        self.assertEqual(
            uac.MNS_LOGON_ACCOUNT
            + uac.DONT_EXPIRE_PASSWORD
            + uac.TRUSTED_FOR_DELEGATION,
            0x20000 + 0x10000 + 0x80000,
        )
    ...
    def test___add2_8(self):
        self.assertEqual(
            ...
            + uac.ENCRYPTED_TEXT_PWD_ALLOWED
            + uac.ACCOUNTDISABLE,
            0x1000000 + 0x0080 + 0x0002,
        )

    def test___add2_9(self):
        self.assertEqual(
            uac.PASSWD_CANT_CHANGE
            + uac.PASSWORD_EXPIRED
            + uac.TRUSTED_FOR_DELEGATION,
            0x0040 + 0x800000 + 0x80000,
        )

    def test___add2_10(self):
        self.assertEqual(
            uac.SMARTCARD_REQUIRED
            + uac.INTERDOMAIN_TRUST_ACCOUNT
            + uac.TRUSTED_TO_AUTH_FOR_DELEGATION,
            0x40000 + 0x0800 + 0x1000000,
        )

    def test___add2_11(self):
        self.assertEqual(
            uac.SERVER_TRUST_ACCOUNT
            + uac.NORMAL_ACCOUNT
            + uac.WORKSTATION_TRUST_ACCOUNT,
            0x2000 + 0x0200 + 0x1000,
        )

    def test___add2_12(self):
        self.assertEqual(
            uac.PASSWORD_EXPIRED + uac.LOCKOUT + uac.TEMP_DUPLICATE_ACCOUNT,
            0x800000 + 0x0010 + 0x0100,
        )
    ...
    def test___add2_13(self):
        self.assertEqual(
            ...
            + uac.TEMP_DUPLICATE_ACCOUNT
            + uac.USE_DES_KEY_ONLY,
            0x0020 + 0x0100 + 0x200000,
        )

    def test___add2_not_13(self):
        self.assertNotEqual(
            uac.PASSWD_NOTREQD + uac.LOCKOUT + uac.USE_DES_KEY_ONLY,
            0x0020 + 0x0100 + 0x200000,
        )
    ...
    def test___add2_16(self):
        self.assertEqual(
            uac.ACCOUNTDISABLE + uac.INTERDOMAIN_TRUST_ACCOUNT + uac.LOCKOUT,
            0x0002 + 0x0800 + 0x0010,
        )

    def test___add2_17(self):
        self.assertEqual(
            uac.NORMAL_ACCOUNT + uac.SCRIPT + uac.NOT_DELEGATED,
            0x0200 + 0x0001 + 0x100000,
        )
    ...
    def test___add2_19(self):
        self.assertEqual(
            ...
            + uac.LOCKOUT
            + uac.TRUSTED_TO_AUTH_FOR_DELEGATION,
            0x400000 + 0x0010 + 0x1000000,
        )

    def test___add2_20(self):
        self.assertEqual(
            uac.USE_DES_KEY_ONLY + uac.SCRIPT + uac.INTERDOMAIN_TRUST_ACCOUNT,
            0x200000 + 0x0001 + 0x0800,
        )
    ...
    def test___add2_21(self):
        self.assertEqual(
            ...
            + uac.PASSWD_CANT_CHANGE
            + uac.SERVER_TRUST_ACCOUNT,
            0x0100 + 0x0040 + 0x2000,
        )

    def test___status_1(self):
        u = uac.get_status(0x1003000)
        u.sort()
    ...
    def test___status_2(self):
        u = uac.get_status(0x140040)
        u.sort()
        self.assertListEqual(
            u, ["NOT_DELEGATED", "PASSWD_CANT_CHANGE", "SMARTCARD_REQUIRED"]
        )

    def test___status_3(self):
        u = uac.get_status(0x41040)
        u.sort()
        self.assertListEqual(
            u,
            [
    ...
    def test___status_6(self):
        u = uac.get_status(0x222)
        u.sort()
        self.assertListEqual(
            u, ["ACCOUNTDISABLE", "NORMAL_ACCOUNT", "PASSWD_NOTREQD"]
        )

    def test___status_7(self):
        u = uac.get_status(0x210010)
        u.sort()
        self.assertListEqual(
            u, ["DONT_EXPIRE_PASSWORD", "LOCKOUT", "USE_DES_KEY_ONLY"]
        )

    def test___status_8(self):
        u = uac.get_status(0x1000A00)
        u.sort()
        self.assertListEqual(
            u,
            [
    ...
    def test___status_10(self):
        u = uac.get_status(0x20060)
        u.sort()
        self.assertListEqual(
            u, ["MNS_LOGON_ACCOUNT", "PASSWD_CANT_CHANGE", "PASSWD_NOTREQD"]
        )

    def test___status_11(self):
        u = uac.get_status(0x800101)
        u.sort()
        self.assertListEqual(
            u, ["PASSWORD_EXPIRED", "SCRIPT", "TEMP_DUPLICATE_ACCOUNT"]
        )

    def test___status_12(self):
        u = uac.get_status(0x401000)
        u.sort()
        self.assertListEqual(
            u, ["DONT_REQ_PREAUTH", "WORKSTATION_TRUST_ACCOUNT"]
        )

    def test___status_13(self):
        u = uac.get_status(0x610000)
        u.sort()
        self.assertListEqual(
            u, ["DONT_EXPIRE_PASSWORD", "DONT_REQ_PREAUTH", "USE_DES_KEY_ONLY"]
        )

    def test___status_14(self):
        u = uac.get_status(0x40120)
        u.sort()
        self.assertListEqual(
            u,
            ["PASSWD_NOTREQD", "SMARTCARD_REQUIRED", "TEMP_DUPLICATE_ACCOUNT"],
        )

    def test___status_15(self):
        u = uac.get_status(0x500200)
        u.sort()
        self.assertListEqual(
            u, ["DONT_REQ_PREAUTH", "NORMAL_ACCOUNT", "NOT_DELEGATED"]
        )

    def test___status_16(self):
        u = uac.get_status(0x810200)
        u.sort()
        self.assertListEqual(
            u, ["DONT_EXPIRE_PASSWORD", "NORMAL_ACCOUNT", "PASSWORD_EXPIRED"]
        )

    def test___status_17(self):
        u = uac.get_status(0x840000)
        u.sort()
        self.assertListEqual(u, ["PASSWORD_EXPIRED", "SMARTCARD_REQUIRED"])

    def test___status_not_17(self):
        u = uac.get_status(0x440000)
        u.sort()
        self.assertNotEqual(u, ["PASSWORD_EXPIRED", "SMARTCARD_REQUIRED"])

    def test___status_18(self):
        u = uac.get_status(0x40810)
        u.sort()
        self.assertListEqual(
            u, ["INTERDOMAIN_TRUST_ACCOUNT", "LOCKOUT", "SMARTCARD_REQUIRED"]
        )

    def test___status_19(self):
        u = uac.get_status(0x91)
        u.sort()
        self.assertListEqual(
            u, ["ENCRYPTED_TEXT_PWD_ALLOWED", "LOCKOUT", "SCRIPT"]
        )

    def test___status_20(self):
        u = uac.get_status(0x300040)
        u.sort()
        self.assertListEqual(
            u, ["NOT_DELEGATED", "PASSWD_CANT_CHANGE", "USE_DES_KEY_ONLY"]
        )

    def test___status_not_20(self):
        u = uac.get_status(0x300020)
        u.sort()
        self.assertNotEqual(
            u, ["NOT_DELEGATED", "PASSWD_CANT_CHANGE", "USE_DES_KEY_ONLY"]
        )
        ...
        self.assertEqual(
            uac.get_control(
                [
                    uac.PASSWD_CANT_CHANGE,
                    uac.INTERDOMAIN_TRUST_ACCOUNT,
                    uac.HOMEDIR_REQUIRED,
                    uac.PASSWD_NOTREQD,
                    uac.ENCRYPTED_TEXT_PWD_ALLOWED,
                ]
            ),
            hex(0x0040 + 0x0800 + 0x0008 + 0x0020 + 0x0080),
        )
    ...
    def test___control_not_1(self):
        self.assertNotEqual(
            ...
            hex(0x0040 + 0x0800 + 0x0008 + 0x0020 + 0x0040),
        )
    ...
    def test___control_2(self):
        self.assertEqual(
            ...
            hex(0x200000 + 0x10000 + 0x0008 + 0x0001 + 0x0020 + 0x0010),
        )
    ...
    def test___control_4(self):
        self.assertEqual(
            ...
            hex(0x400000 + 0x200000 + 0x0020 + 0x20000 + 0x80000),
        )
    ...
    def test___control_5(self):
        self.assertEqual(
            ...
            hex(0x1000 + 0x0200 + 0x0020 + 0x0080 + 0x20000 + 0x10000),
        )
    ...
    def test___control_6(self):
        self.assertEqual(
            ...
            hex(0x0008 + 0x400000 + 0x200000 + 0x0010),
        )
    ...
    def test___control_8(self):
        self.assertEqual(
            ...
            hex(0x0040 + 0x0001 + 0x200000 + 0x0008),
        )
    ...
    def test___control_10(self):
        self.assertEqual(
            ...
            hex(0x0080 + 0x100000 + 0x10000 + 0x80000),
        )
    ...
    def test___control_12(self):
        self.assertEqual(
            ...
            hex(0x0040 + 0x80000 + 0x0008 + 0x0002),
        )
    ...
    def test___control_13(self):
        self.assertEqual(
            ...
            hex(0x0200 + 0x0100 + 0x1000 + 0x0080),
        )
    ...
    def test___control_14(self):
        self.assertEqual(
            ...
            hex(0x20000 + 0x0080 + 0x0800 + 0x0001 + 0x0008),
        )
    ...
    def test___control_15(self):
        self.assertEqual(
            ...
            hex(0x0100 + 0x0010 + 0x1000000 + 0x0040 + 0x1000),
        )
    ...
    def test___control_18(self):
        self.assertEqual(
            ...
            hex(0x0008 + 0x0010 + 0x80000 + 0x100000 + 0x800000 + 0x0200),
        )
    ...
    def test___control_19(self):
        self.assertEqual(
            ...
            hex(0x0800 + 0x0100 + 0x0040 + 0x1000000),
        )
    ...
    def test___control_20(self):
        self.assertEqual(
            ...
            hex(0x1000 + 0x400000 + 0x2000 + 0x0200 + 0x800000),
        )
    ...
    def test___control_21(self):
        self.assertEqual(
            ...
            hex(0x0001 + 0x400000 + 0x0100 + 0x80000 + 0x0008 + 0x20000),
        )
    ...
    def test___control_not_21(self):
        self.assertNotEqual(
            ...
            hex(0x0002 + 0x400000 + 0x0100 + 0x80000 + 0x0008 + 0x20000),
        )
