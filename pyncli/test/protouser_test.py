...
class TestUserMetods(unittest.TestCase):
    ...
    def test___init_1(self):
        self.assertRaises(EmptyParam,protouser.protouser,u'')
...
##        self.assertRaises(WrongParam,protouser.protouser,'Пупкин','126546')
    ...
    def test___init_4(self):
        u=protouser.protouser(u'pupok')
        self.assertEqual(u.__class__.__name__,u'protouser')

    def test___init_5(self):
        self.assertRaises(TooLong,protouser.protouser,u'ю'*65)
...
class TestUserMetods2(unittest.TestCase):
    ...
    def setUp(self):
        self.protouser=protouser.protouser(u'pupok')

    def tearDown(self):
        self.protouser=None

    def test___init_5(self):
        self.assertEqual(self.protouser.__class__.__name__,u'protouser')


    def test___init_6(self):
        self.assertEqual(self.protouser.login,u'pupok')
...
##        self.assertEqual(self.protouser.uid,u'45564')
    ...
    def test___eq_3(self):
        u=protouser.protouser(u'1pupok')
        self.assertFalse(self.protouser==u)

    def test___eq_4(self):
        u=protouser.protouser(u'upupok')
        self.assertFalse(self.protouser==u)
    ...
    def test___ne_2(self):
        u=protouser.protouser(u'pupok2')
        self.assertTrue(self.protouser!=u)

    def test_diff_1(self):
        protouser1=protouser.protouser(u'pupok1')
        self.assertDictEqual(self.protouser.diff(protouser1),{u'login':u'pupok1'})
...
##        self.assertDictEqual(self.protouser.diff(protouser1),{u'uid':u'455642'})
    ...
    def test_diff_ldap_attrs_1(self):
        protouser1=protouser.protouser(u'pupo3k')
        self.assertDictEqual(self.protouser.diff_ldap_attrs(protouser1),{u'sAMAccountName':u'pupo3k'})

    def test_diff_ldap_attrs_2(self):
        protouser1=protouser.protouser(u'pupok8')
        self.assertDictEqual(self.protouser.diff_ldap_attrs(protouser1),{u'sAMAccountName':u'pupok8'})

class TestUserMetods3(unittest.TestCase):

    def setUp(self):
        self.protouser=protouser.protouser(u'pupok.kuvirok')
    ...
    def test___get_ldap_attrs_1(self):
        at={u'sAMAccountName':u'pupok.kuvirok'}
        self.assertEqual(self.protouser.get_ldap_attrs(),at)

    def test___get_ldap_attrs_1(self):
        at={u'sAMAccountName':u'pupok.kuvirok', u'test':u''}
        self.assertNotEqual(self.protouser.get_ldap_attrs(),at)

    def test___diff_ldap_attrs_by_categories_1(self):
        protouser1=protouser.protouser(u'pupok8')
        self.assertRaises(WrongParam,protouser.protouser.diff_ldap_attrs_by_categories,self.protouser,protouser1)
